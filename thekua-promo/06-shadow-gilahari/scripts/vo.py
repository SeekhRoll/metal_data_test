...
Voice (brief + client): a male storyteller, soothing, smooth, erudite and reverential, like a kathavachak
telling the tale beside the puppet lamp. One take per line in src/film/vo.json -> assets/vo/<id>.wav.
...
DESCRIPTION = (
    "Rohit speaks in a deep, calm, smooth and reverential voice, like a learned storyteller narrating a sacred tale, "
    "at a slow, unhurried pace with gentle, expressive intonation. The recording is very clear and close-up, "
