...
1. Edit the top of `promo.html`: `BRAND`, `PHONE` (currently a placeholder, `+91 XXXXX XXXXX`) and `AREA`. The promise claims are in `PROPS`. Change any that don't match your kitchen, such as the "no preservatives" or "fresh every week" cards or the sectors 1–29 delivery area.
